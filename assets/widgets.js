/* learn-data-literacy-with-phoebe - interactive widgets (no code, exec-friendly)
   Usage: <div class="widget" data-widget="TYPE" data-config='{...json...}'></div>
   Types: sorter · meanmedian · kpitree · funnel · rfm · forecast · threshold · kmeans · clv
...
(function () {
  ...
  /* ---------- boot ---------- */
  var registry = { sorter: wSorter, meanmedian: wMeanMedian, kpitree: wKpiTree, funnel: wFunnel,
